 ...
 * coordonnées sont en pixels. On peut interroger l'objet pour connaitre la matrice de transformation, le nombre de pixels par unit?, 
...
public class ModeleAffichage {
	 ...
	 * @param largUnitesReelles La largeur considérée dans le monde, en unit? réelles
	 * @param hautUnitesReelles La hauteur considérée dans le monde, en unit? réelles  
	...
	public ModeleAffichage(double largPixels, double hautPixels, double xOrigUnitesReelle, double yOrigUnitesReelle, double largUnitesReelles, double hautUnitesReelles) {
		...
		this.matMC = mat; //on mémorise la matrice (qui pourra être retournée via le getter associ?)
	 ...
	 * réel est passée en paramètre (largeur ou hauteur). L'autre dimension sera  calculée de façon ? n'introduire aucune distortion.
	 * 
	 * @param largPixels La largeur du composant, en pixels
	 * @param hautPixels La hauteur du composant, en pixels
	 * @param xOrigUnitesReelle L'origine en x de la portion du monde réel que l'on veut montrer 
	 * @param yOrigUnitesReelle L'origine en y de la portion du monde réel que l'on veut montrer 
	 * @param dimensionEnUnitesReelles La dimensions considérée dans le monde, en unit? réelles (il peut s'agir d'une largeur ou d'une hauteur, dépendant du dernier paramètre)
	 * @param typeLargeur Booléen qui vaut vrai si la dimension fournie est la largeur du monde, vaut faux si la dimension fournie est la hauteur du monde
	 */
	...
	/**
	 * Création d'un objet ModeleAffichage o? la dimension passée en paramètre est forcément la largeur du monde
	 * 
	 * @param largPixels La largeur du composant, en pixels
	 * @param hautPixels La hauteur du composant, en pixels
	 * @param xOrigUnitesReelle L'origine en x de la portion du monde réel que l'on veut montrer 
	...
	/**
	 * Création d'un objet ModeleAffichage o? l'origine du monde réel est ? 0,0
	 * 
	 * @param largPixels La largeur du composant, en pixels
	 * @param hautPixels La hauteur du composant, en pixels
	 * @param dimensionEnUnitesReelles La dimensions considérée dans le monde, en unit? réelles (il peut s'agir d'une largeur ou d'une hauteur, dépendant du dernier paramètre)
	...
	/**
	 *  Création d'un objet ModeleAffichage o? l'origine du monde réel est ? 0,0, et o? la dimension passée en paramètre est forcément la largeur du monde
	 *  
	 * @param largPixels La largeur du composant, en pixels
	 * @param hautPixels La hauteur du composant, en pixels
	 * @param xOrigUnitesReelle L'origine en x de la portion du monde réel que l'on veut montrer 
	...
	/**
	 * Retourne une copie de la matrice monde-vers-composant qui a ét? calculée dans le constructeur
	...
	/**
	 * Retourne le nombre de pixels contenus dans une unit? du monde réel, en x
	 * @return Le nombre de pixels contenus dans une unit? du monde réel, en x
	 */
	...
	/**
	 * Retourne le nombre de pixels contenus dans une unit? du monde réel, en y
	 * @return Le nombre de pixels contenus dans une unit? du monde réel, en y
	 */

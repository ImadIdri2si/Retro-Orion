...
/**
 * La classe Vecteur permet de realiser les operations de base sur un vecteur Euclidien en deux dimensions (x,y), oï¿? x et y sont les 
 * composantes du vecteur.
 * 
 * Cette classe est une version 2d modifiï¿½e de la classe SVector3d ecrite par Simon Vezina.
 * 
...
public class Vecteur implements Serializable{
	...
	/**
	 * Methode qui calcule et retourner l'addition du vecteur courant et d'un autre vecteur. Le vecteur courant reste inchangï¿?.
	...
	/**
	 * Methode qui calcule et retourne le vecteur resultant de la soustraction d'un vecteur quelconque du vecteur courant. Le vecteur courant reste inchangï¿?.
	...
	/**
	 * Methode qui effectue la multiplication du vecteur courant par une scalaire.Le vecteur courant reste inchangï¿?.
	...
	public Vecteur normalise() throws Exception
	{
		...
		if(mod < EPSILON) 
		  throw new Exception("Erreur Vecteur: Le vecteur " + this.toString() + " ï¿½tant nul ou presque nul ne peut pas etre normalisï¿?.");
		else
